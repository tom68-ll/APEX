...
class Hypothesis(object):
    def __init__(self, sid, is_sketch=False):
        self.sid = sid
        self.actions = []
        self.action_infos = []
        self.inputs = []
    ...
    def clone_and_apply_action_info(self, action_info):
        ...
        new_hyp.sketch_att = copy.copy(self.sketch_att)

        return new_hyp

    def copy(self):
        new_hyp = Hypothesis(sid=self.sid, is_sketch=self.is_sketch)
        # if self.tree:
