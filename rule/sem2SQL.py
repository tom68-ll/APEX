...
from define_rule import Sup, Sel, Order, Root, Filter, A, N, C, T, Root1
from rule.sem_utils import alter_inter, alter_not_in, alter_column0, load_dataSets
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--output_path', type=str, help='output task_splits')
