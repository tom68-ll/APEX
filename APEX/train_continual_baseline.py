...
import sys
sys.path.append("..")
from amtm_test.amtm import AMTMTrainer
from amtm_test.amtm_clloss import AMTMTrainer_clloss
from amtm_test.adapterpooling import AdapterPoolingTrainer
from amtm_test.amtm_SQL import AMTMSQL
from amtm_test_T53B.amtm_clloss_sft import AMTMTrainer_T53B
...
def run_training():
    ...
    elif args.baseline_name == "amtm_clloss":
        trainer = AMTMTrainer_clloss(args,model_save_path)
    elif args.baseline_name == "adapterpooling":
        trainer = AdapterPoolingTrainer(args, model_save_path)
    elif args.baseline_name == "amtmSQL":
        trainer = AMTMSQL(args, model_save_path)
