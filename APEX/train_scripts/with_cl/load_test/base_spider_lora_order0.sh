...
--task_path ./data/spider/augmented_data/spider_aug_3_slightly_processed/task_{}/{} \
...
--adapter_root_path ./model_saved/withcl/20240905-1035 \
--prediction_save_path ./result/20240904/T5-base/spider/lora/withcl_order0/load_test \
